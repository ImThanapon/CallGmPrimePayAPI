...
$sql_cre_order = "INSERT INTO order_detail(customer_id, product_id, result_code, ref_no, date_payment, amount, pay_method)
                      VALUES ('cus0001','$id','99','$refNo',null, '$price', 'recurring') ";
            ...
            <div class="card" style="border-radius: 40px; margin: 5% 35% 0 35%; padding: 5% 0 5% 0">
                ...
                <form action="#" method="POST">
                    <div class="row m-3 text-left">
                        ...
                        <div class="col">
                            <input class="mb-2" id="recurringAmount" type="text" maxlength="250" placeholder="Recurring Amount" value=""><br />
                            <input class="mb-2" id="name" type="text" maxlength="250" placeholder="Holder Name" value=""><br />
                            <input class="mb-2" id="number" type="text" maxlength="16" placeholder="Card Number" value=""><br />
                            <input class="mb-2" id="expirationMonth" type="text" maxlength="2" placeholder="MM" value=""><br />
                            <input class="mb-2" id="expirationYear" type="text" maxlength="2" placeholder="YY (Last Two Digits)" value=""><br />
                            <input class="mb-2" id="securityCode" type="password" maxlength="3" autocomplete="off" placeholder="CVV" value=""><br />
                        </div>
                    </div>
        ...
        document.getElementById("button").addEventListener("click", function(event) {
            ...
            $.ajax({
                ...
                success: function(dataResp) {
                    ...
                    window.location.href = "<?= $host ?>payment/recurring.php?token=" + dataResp['card'].token + "&refNo=<?= $_GET['refNo'] ?>&price=<?= $_GET['price'] ?>&recAmount=" + document.getElementById("recurringAmount").value;
                },
