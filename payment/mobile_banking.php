        ...
        <div class="text-center mt-5">
            ...
            <div class="card" style="border-radius: 40px; margin: 5% 20% 0 20%; padding: 5% 10% 5% 10%">
                <div class="d-flex justify-content-center">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/mobile-banking-app-4080602-3468647.png" width=200px">
                </div>
                ...
                <form id="mobileBankingform" action="<?= $testUrlAPI ?>v2/mobileBanking" method="POST">
                    ...
                    <div class="m-3">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" class="form-control" name="amount" maxlength="13" placeholder="Amount" value="<?= $price ?>" />
                        </div>
                        <div class="input-group input-group-sm mb-3">
