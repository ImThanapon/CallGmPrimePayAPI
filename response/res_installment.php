...
// $respTotalAmount = $_POST["totalAmount"];
// fwrite($respFile, "totalAmount : " . $respTotalAmount . "\n");

// $respThbAmount = $_POST["thbAmount"];
// fwrite($respFile, "thbAmount : " . $respThbAmount . "\n");

fclose($respFile);

date_default_timezone_set('Asia/Bangkok');
$date_pay = date("y-m-d H:i:s");
if ($respResultCode == '00') {
